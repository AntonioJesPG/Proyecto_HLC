...
public final class adminUser_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("usuarioModificado")!=null){
      ...
      out.write("            <tr><th></th><th>Nombre</th><th>DNI</th><th>Dirección</th><th>Teléfono</th><th>Email</th><th>Saldo</th><th></th><th></th></tr>\n");
      out.write("            \n");
      out.write("        ");
            ...
            for(Usuario u : usuarios){
                ...
                out.println("<td><form action='modificarUsuario.jsp' method='POST'><button type='submit' name='modificar' value='" + u.getId() + "'>Modificar</button></form></td>");
