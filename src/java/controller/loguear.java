...
public class loguear extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("usuario").equals("admin") && uc.comprobarUsuario(request.getParameter("usuario"), request.getParameter("pass"))) {
                userSession.setAttribute("logueado", "admin");
                response.sendRedirect("VistaAdministrador.jsp");
            } else {
                if(uc.comprobarUsuario(request.getParameter("usuario"), request.getParameter("pass"))){
                    userSession.setAttribute("logueado", request.getParameter("usuario"));
